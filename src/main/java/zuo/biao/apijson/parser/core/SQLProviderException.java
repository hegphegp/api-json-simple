...
import zuo.biao.apijson.parser.core.Message.ErrorElement;
...
public class SQLProviderException extends Exception {
    ...
    public SQLProviderException(List<ErrorElement> errors) {
        ...
        for (int i = 0; i < errors.size(); i++) {
            errorMsgs.add(errors.get(i).getErrorMsg() + System.getProperty("line.separator"));
            sb.append(i + ".Error message: ----> " + errors.get(i).getErrorMsg() + System.getProperty("line.separator"));
